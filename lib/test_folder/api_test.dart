            ...
            builder: (context, state) {
              return state.map(
                ...
                getFeaturedBoats: (value) {
                  ...
                  //   favoritePackageIds = snapshot.data!.data!
                  //       .map((e) => e.package?.id)
                  //       .whereType<int>()
                  //       .toList();
                  // }
                  ...
                  //   (index) => favoritePackageIds.contains(
                  //       value.featuredBoats.data?[index].packages?[0].id),
                  // );
                  // if (isFavoriteList.length <
                  //     (value.featuredBoats.data?.length ?? 0)) {
                  //   List<int> favoritePackageIds = snapshot.data?.data
                  //           ?.map((e) => e.package?.id)
                  //           .whereType<int>()
                  //           .toList() ??
                  //       [];
                  ...
                  //     (value.featuredBoats.data?.length ?? 0),
                  //     (index) {
                  //       if (value.featuredBoats.data == null ||
                  //           value.featuredBoats.data!.isEmpty) {
                  //         return false;
                  //       }
                  //       return favoritePackageIds.contains(
                  //         value.featuredBoats.data![index].packages
                  //             ?.firstOrNull?.id,
                  //       );
                  //     },
                  //   );
                  ...
                  print(
                      "Favorites package Id from favourites api : //${snapshot.data?.data?[0].package?.id}");
                  print(
                      "Favorites package Id from Features api ${value.featuredBoats.data?[0].packages?[0].id}");
                  return Column(
                          children: [
                            SizedBox(
                              height: 50,
